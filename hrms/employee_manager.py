...
class EmployeeManager:
    def __init__(self):
        # Values can include None (e.g. manager_id) so don't restrict to str.
        self.employees: Dict[str, Dict[str, object]] = {}
    ...
    def get_employee_details(self, emp_id: str) -> Dict[str, object]:
        if emp_id not in self.employees:
            raise ValueError(f"Employee ID '{emp_id}' not found.")
