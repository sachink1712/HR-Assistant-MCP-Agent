...
def seed_services(employee_manager, leave_manager, meeting_manager, ticket_manager):
    ...
    employees_data = [
        ...
        {"emp_id": "E003", "name": "Tamil Selvi", "manager_id": None, "email": "tamil.selvi@atliq.com"},

        # Engineering team under Sarah
        {"emp_id": "E004", "name": "Tony Sharma", "manager_id": "E001", "email": "tony.sharma@atliq.com"},
        {"emp_id": "E005", "name": "James Rodriguez", "manager_id": "E001", "email": "james.rodriguez@atliq.com"},

        # Product team under Michael
        {"emp_id": "E006", "name": "Emily Kim", "manager_id": "E002", "email": "emily.kim@atliq.com"},
        {"emp_id": "E007", "name": "Carlos Mendez", "manager_id": "E002", "email": "carlos.mendez@atliq.com"},
        {"emp_id": "E008", "name": "Lisa Wong", "manager_id": "E003", "email": "lisa.wong@atliq.com"},
    ]
